...
import com.leyou.common.BaseResponse;
import com.leyou.enumeration.BaseRespEnum;
import com.leyou.enumeration.EnableEnum;
import com.leyou.enumeration.SecurityEnum;
//import com.leyou.service.ISecurityManageService;
...
/*    @Autowired
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
       ...
       // Map<Integer, Integer> typeStatusMap = securityManageService.getTypeStatusMap(Collections.singletonList(SecurityEnum.CSRF.getType()));
        ...
        // 是否不开启,直接放行
        HashMap<Integer, Integer> typeStatusMap = new HashMap<>();
        Integer status = typeStatusMap.get(SecurityEnum.CSRF.getType());
        status = 0; //当前CSRF功能已禁用
