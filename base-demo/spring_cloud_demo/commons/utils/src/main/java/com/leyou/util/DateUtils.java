...
import com.leyou.constants.WeekEnum;
...
public class DateUtils {
    ...
    public static final String FORMAT_YYYY_MM_DDTHH_MM_SSZ = "yyyy-MM-dd'T'HH:mm:ss.SSS";
    ...
    public static Boolean isLeapYear(String stringDate) {
        ...
        Calendar calendar = calendarInitialer(stringDate, FORMAT_YYYY_MM_DD);
        assert calendar != null;
    ...
    public static int calcAge(String birthDay, String calcDate) {
        ...
        int cMonth = getMonth(calcDate, FORMAT_YYYY_MM_DD);
        int cDay = getDay(calcDate, FORMAT_YYYY_MM_DD);
        int bYear = getYear(birthDay);
        int bMonth = getMonth(birthDay, FORMAT_YYYY_MM_DD);
        int bDay = getDay(birthDay, FORMAT_YYYY_MM_DD);
    ...
    public static String getBirthdayFromIDCard(String idno) {
        ...
        return dateToString(instance.getTime(), FORMAT_YYYY_MM_DD);
    }
